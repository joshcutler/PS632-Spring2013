...
# what's the minimum population in 1990? 
d1990 = data[data['yr']==1990]
min(d1990['pop'])

# in which state was that? 
d1990[d1990['pop']==min(d1990['pop'])]
# another way
d1990['st'][ d1990['pop'].idxmin() ]

# how many states had over 35 electoral votes in 2010? 
d2010 = data[data['yr']==2010]
d2010[d2010['ev']>35]
...
d2010.sum()
# how many people did the average congressperson represent in 1990?
d1990['pop'].sum() / (538 - 100)
...
p['North Carolina']
p.mean(level='st')
# how would you calc std dev by year? 
p.std(level='yr')
p.swaplevel('st', 'yr')
